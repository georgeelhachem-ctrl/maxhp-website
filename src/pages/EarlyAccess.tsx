    ...
    <>
      ...
      <section className="bg-[#f7f9fb] pt-16 pb-16 border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <h1
            className="text-5xl lg:text-6xl font-black tracking-tight text-[#191c1e] mb-5 max-w-3xl"
      ...
      <section className="py-20 bg-white">
        <div className="max-w-3xl mx-auto px-6 lg:px-8">
          ...
          {/* HubSpot embed */}
          <div className="bg-[#f7f9fb] border border-slate-100 rounded-2xl p-6 shadow-card mb-10">
            <iframe
